...
# EMAIL_PORT = 587
# EMAIL_USE_TLS = True
# EMAIL_HOST_USER = 'mesprojets377@gmail.com'
# EMAIL_HOST_PASSWORD = 'jjyu tgdg ywfd hyqk'
...
DEBUG =True #config('DEBUG', default=False, cast=bool)  # Mettre à False en production
...
TEMPLATES = [
    {
        ...
        'OPTIONS': {
            'context_processors': [
                ...
                'messagerie.context_processors.messagerie_context',
            ],
        },
    },
]
