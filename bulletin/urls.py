...
urlpatterns = [
    ...
    path('bulletins_annuels/niveau', views.bulletins_annuels_niveau, name='bulletins_annuels'),  # Affiche la page des bulletins annuels
    ...
    path('ajax/niveaux/', views.get_niveaux_par_cycle, name='ajax_niveaux'),

        path('bulletin/annuel/classe/', views.bulletins_annuels_classe, name='bulletins_annuels_classe'),
